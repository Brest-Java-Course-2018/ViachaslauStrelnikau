 ...
 * Shows dialog after 15 minutes of idle and ask user if he is wiiling to continue session or logout
 * if user is still idle then after a 60 seconds auto logout occurs
 */
Ext.define('BizDash.util.SessionMonitor', {
    requires: [
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function() {
                Ext.TaskManager.stop(BizDash.util.SessionMonitor.countDownTask);
                BizDash.util.SessionMonitor.window.hide();
